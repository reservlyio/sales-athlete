      ...
      <div className="flex gap-0.5 mb-10 bg-muted rounded-full px-2 py-1.5 overflow-x-auto no-scrollbar">
        {TABS.map((t) => (
          <button
            key={t.id}
            onClick={() => setTab(t.id)}
            className={`md:flex-1 whitespace-nowrap px-5 py-2 rounded-full text-sm font-medium transition-all ${
              tab === t.id
                      ...
                      <div className="flex items-center gap-3 md:gap-2 px-4 py-3 md:px-3 md:py-2.5 hover:bg-accent/30">
                        ...
                        <div className="flex flex-col md:flex-row gap-2 shrink-0">
                          <button
                            ...
                            className={`inline-flex items-center gap-1.5 text-xs font-semibold px-5 py-2.5 md:px-4 md:py-2 rounded-full border transition-all select-none ${
                          ...
                          <button
                            ...
                            className={`inline-flex items-center gap-1.5 text-xs font-semibold px-5 py-2.5 md:px-4 md:py-2 rounded-full border transition-all ${
